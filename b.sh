...
export ARCH=arm64
export KBUILD_BUILD_HOST="retardkernel"
...
cd AnyKernel
zip -r9 LiquidKernel-V1.5-ShinomiyaKaguya-rosemary.zip *
curl -T LiquidKernel-V1.5-ShinomiyaKaguya-rosemary.zip temp.sh
}
